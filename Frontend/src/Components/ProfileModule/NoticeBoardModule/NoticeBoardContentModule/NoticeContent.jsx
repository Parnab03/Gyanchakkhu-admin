    ...
    <>
      ...
      <div className={Styles.maincontainer}>
        <div className={Styles.NoticeContainer}>
          <div className={Styles.NDetails}>
            ...
            <div className={Styles.N_Title}>
              <span>
                Library Timings Updated  New operational hours starting from
                next month.
              </span>
            </div>
          ...
          <div className={Styles.N_Body}>
            ...
            {<br />}
            {<br />}
              This is to inform you that the operational hours of Gyanchakkhu
              Library will be revised starting from [Effective Date]. Please
              take note of the updated schedule:
              <br />
              New Library Timings: {<br />}
              Monday - Friday: 10:00am-7:00pm {<br />}
              Saturday - Sunday: Full Day {<br />}
              We request all members to plan their visits accordingly. For any
              queries, please contact the library help desk. {<br />}
        ...
        <div className={Styles.footer}>
          <img src={copyright} alt="CopyRight" className={Styles.copyright} />
