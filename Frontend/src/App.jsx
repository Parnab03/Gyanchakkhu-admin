    ...
    return (
        <>
            ...
            <div className="content">
                ...
                <ul>
                    <li>
                        Each module should be in a well-named folder under the
                    ...
                    <ul>
                        ...
                        <li>
                            Login and Register - <strong>AuthModule</strong>{" "}
                            folder
                        </li>
                        <li>
                            Navbar and Footer - <strong>CommonModule</strong>{" "}
                            folder
                        </li>
                    </ul>
                ...
                <ul>
                    <li>
                        Place images in the public folder in recommended SVG
                        format whenever possible.
                    </li>
                    <li>
                        If a non-SVG image is necessary, use a dedicated local
                        folder.
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        Write minimal and clean CSS. Avoid excessive styling.
                    </li>
                </ul>
